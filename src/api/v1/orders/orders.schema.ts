...
export const updateOrderSchema = z.object({
  products: z.array(orderItemSchema).min(1, "At least one product is required").optional(),
  shippingAddress: shippingAddressSchema.optional(),
  paymentMethod: z.enum(['credit_card', 'paypal', 'cash_on_delivery', 'stripe']).optional(),
